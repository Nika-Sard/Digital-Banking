...
public class Controller {
    ...
    @PostMapping("/doTransaction/{senderId}/{receiverId}/{amount}/{message}")
    public void doTransaction(@PathVariable String senderId, @PathVariable String receiverId,
                              @PathVariable double amount, @PathVariable String message) {
        service.makeTransaction(senderId, receiverId, amount, message);
    }
